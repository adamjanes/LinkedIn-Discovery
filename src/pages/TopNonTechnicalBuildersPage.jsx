...
function TopNonTechnicalBuildersPage() {
  ...
  const loadNetworkData = async () => {
    try {
      ...
      // Use a fixed user ID and network ID for this sharable page
        ...
        <div className="mb-12">
          <div className="text-center">
            <h1 className="text-5xl font-bold text-gray-900 mb-4">
              Top Non-Technical Builders
            </h1>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Discover the network of influential non-technical professionals
...
export default TopNonTechnicalBuildersPage
